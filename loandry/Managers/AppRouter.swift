...
final class AppRouter {
    ...
    static func parse(url: URL) -> Route? {
        guard let scheme = url.scheme?.lowercased(), scheme == "loandry" else {
            return nil
        }

        // Supports:
        // loandry://loan/<loan_id>?payment_id=<payment_id>
        // loandry://loan?loan_id=<loan_id>&payment_id=<payment_id>
